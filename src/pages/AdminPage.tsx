...
import JovensTable from '../components/admin/JovensTable';
import DetalheModal from '../components/admin/DetalheModal';
import { MODULOS } from '../data/modulos';
import { obterJovensUnicos } from '../lib/storage';
...
export default function AdminPage() {
  ...
  const filtrados = jovens.filter((j) => j.nome.toLowerCase().includes(busca.toLowerCase()));
